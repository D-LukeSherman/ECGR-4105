...
def gradient_descent(X, y, z, v, theta, alpha, iterations):
    ...
    for i in range(iterations):
        predictions = X.dot(theta)
        errors = np.subtract(predictions, y)
        sum_delta = (alpha / m) * (X.transpose().dot(errors) + beta * theta)
        sum_delta[0] -= (alpha * beta * temp_theta0) / m # Undo Regularization for theta_0
        theta -= sum_delta
...
# Show the plot
plt.show()
print('Final Error A1: ', cost_history_v[iterations - 1]/(10**9))
...
# Show the plot
plt.show()
print('Final Error B1: ', cost_history_v[iterations - 1]/(10**9))
...
# Show the plot
plt.show()
print('Final Error A2: ', cost_history_v[iterations - 1]/(10**9))
...
# Show the plot
plt.show()
print('Final Error B2: ', cost_history_v[iterations - 1]/(10**9))
